...
CREATE TABLE IF NOT EXISTS `proytkd`.`usuario` (
  ...
  INDEX `fk_usuario_tipo_usuario1_idx` (`idTipo_usuario` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `proytkd`.`administrador` (
  ...
  INDEX `fk_administrador_usuario_temporal1_idx` (`idAdministrador` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `proytkd`.`auditoria_admin_evento` (
  ...
  INDEX `fk_auditoria_admin_evento_administrador1_idx` (`administrador_idAdministrador` ASC) VISIBLE,
