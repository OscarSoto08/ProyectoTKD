...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 13, 2024 at 08:32 PM
...
(1, 'Oscar Alejandro', 'Gonzalez Soto', 'oscaralejandrosoto9@gmail.com', '202cb962ac59075b964b07152d234b70', 'activo', '3135746229', NULL, '2005-08-14');
...
--
ALTER TABLE `galeria_evento`
  MODIFY `idGaleria_Evento` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `evento`
  ADD CONSTRAINT `fk_Evento_Ciudad1` FOREIGN KEY (`Ciudad_idCiudad`) REFERENCES `ciudad` (`idCiudad`);
