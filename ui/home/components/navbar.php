                ...
                <ul class="navbar-nav flex-grow-1 pe-3">
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-dark">
                            <li><a class="dropdown-item" data-page="ui/home/pages/brief-info.php">Información General</a></li>
                            <li><a class="dropdown-item" data-page="ui/home/pages/history.php">Historia</a></li>
                            <li><hr class="dropdown-divider"></li>
                            <li><a class="dropdown-item" data-page="ui/home/pages/tree.php">Árbol Genealógico</a></li>
                        </ul>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="ui/home/pages/events.php" data-page="ui/home/pages/events.php">Eventos</a>
                    </li>
                </ul>
                <!-- Redes sociales -->
